...
# loading and training the model and label encoder
...
def predict_data(X):
    ...
    pred_idx = model.predict(X)[0] #predicting the class index

    species = label_encoder.inverse_transform([pred_idx])[0] #decoding the species label
